...
func TestNormalizePath(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Applications list path",
			path:     "/api/v1/applications",
			expected: "/api/v1/applications",
		},
		{
			name:     "Single application path",
			path:     "/api/v1/applications/my-app",
			expected: "/api/v1/applications/{name}",
		},
		{
			name:     "Application with nested resource path",
			path:     "/api/v1/applications/my-app/resource-tree",
			expected: "/api/v1/applications/{name}/resource-tree",
		},
		{
			name:     "Application with deeply nested resource path",
			path:     "/api/v1/applications/my-app/resource-tree/extra/segments",
			expected: "/api/v1/applications/{name}/resource-tree",
		},
		{
			name:     "Other API path",
